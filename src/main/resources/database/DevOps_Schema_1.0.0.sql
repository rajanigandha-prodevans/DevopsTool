...
CREATE TABLE `assessment` (
  ...
  CONSTRAINT `assessment_status_id` FOREIGN KEY (`assessment_status_id`) REFERENCES `assessment_status` (`assessment_status_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `assessment_answer_table` (
  `assessment_process_id` bigint(11) NOT NULL,
  `question_option_id` int(11) DEFAULT NULL,
  KEY `Assessment_idx` (`assessment_process_id`),
  KEY `question_answer_idx` (`question_option_id`),
  CONSTRAINT `Assessment` FOREIGN KEY (`assessment_process_id`) REFERENCES `assessment_process` (`assessment_process_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `question_answer` FOREIGN KEY (`question_option_id`) REFERENCES `question_option` (`question_option_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `assessment_process` (
  ...
  CONSTRAINT `fk_Assessment_id` FOREIGN KEY (`assessment_id`) REFERENCES `assessment` (`assessment_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_category_id` FOREIGN KEY (`category_id`) REFERENCES `question_category` (`category_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_question_id` FOREIGN KEY (`question_id`) REFERENCES `assessment_question` (`question_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `assessment_question` (
  ...
  CONSTRAINT `category_id` FOREIGN KEY (`category_id`) REFERENCES `question_category` (`category_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `question_type_id` FOREIGN KEY (`question_type_id`) REFERENCES `question_type` (`question_type_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `assessment_result` (
  ...
  `process_and_culture_score` float NOT NULL,
  `build_process_score` float NOT NULL,
  `deployment_score` float NOT NULL,
  `infrastructure_score` float NOT NULL,
  `technology_and_automation_score` float NOT NULL,
  `monitoring_and_feedback_score` float NOT NULL,
  ...
  CONSTRAINT `assessment_id` FOREIGN KEY (`assessment_id`) REFERENCES `assessment` (`assessment_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `result_maturity_id` FOREIGN KEY (`result_maturity_id`) REFERENCES `result_maturity` (`result_maturity_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `question_option` (
  ...
  KEY `question_id_idx` (`question_id`),
  CONSTRAINT `question_id` FOREIGN KEY (`question_id`) REFERENCES `assessment_question` (`question_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `user` (
  ...
  CONSTRAINT `fk_industry_id` FOREIGN KEY (`industry_type_id`) REFERENCES `industry_type` (`industry_type_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
